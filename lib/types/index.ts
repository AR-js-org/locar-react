...
export type LocARProps = { options?: BasicAppOptions, fakeLon?: number, fakeLat?: number, elevation?: number, children?: ReactNode, onGpsUpdate?: (position: GeolocationPosition) => void };

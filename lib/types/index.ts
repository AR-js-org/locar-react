...
export type LocARProps = { options?: BasicAppOptions, fakeLon?: number, fakeLat?: number, elevation?: number, children?: ReactNode, onGpsUpdate?: (position: PositionUpdateInfo) => void };
...
export type PositionUpdateInfo = { position: GeolocationPosition, distMoved: number };